...
Интеграционный модуль для 1С:Предприятие, который позволяет реализовать на проектах 1С полноценный подход к организации процедур интеграции, устранив ключевую проблему множества сложностей, сбоев и других непредвиденных ситуаций.

Речь идёт об xml файлах которые содержат правила интеграции и сами эти правила, которые не поддаются полноценному контролю управления версиями, не синхронизированы с событиями реализного цикла.
...
4. [Быстрый старт](#quick_start)
   ...
   * 4.2. [рдв_РегистрацияИзмененийДемо](#reg_demo)
   * 4.3. [рдв_ОбработчикиСобытийДемо](#events_demo)
   * 4.4. [рдв_РаботаСОчередямиДемо](#queue_demo)
   * 4.5. [RMQ](#rmq)
5. [Лицензия](#license)
6. [Документация](#doc)
7. [Прошлое](#past)
8. [Как и где получить помощь](#how_to_get_help)
9. [Совместное развитие](#joint_development)
   * 9.1. [Как вы можете помочь](#how_to_help)
   * 9.2. [Как происходит процесс contribution](#contribution)
   * 9.3. [Наши обязательства перед сообществом](#obligations_to_the_community)

##  2. <a name='when_to_use'></a>Когда  использовать
...
##  3. <a name='how_to_install'></a>Как это установить

[Инструкция по установке](./doc/how_to_install_mi.md)

##  4. <a name='quick_start'></a>Быстрый старт
...
В модулях реализовать программный интерфейс:

####  4.1. <a name='exchange_demo'></a>рдв_МенеджерОбменаДемо
...
####  4.2. <a name='reg_demo'></a>рдв_РегистрацияИзмененийДемо
...
####  4.3. <a name='events_demo'></a>рдв_ОбработчикиСобытийДемо
...
####  4.4. <a name='queue_demo'></a>рдв_РаботаСОчередямиДемо
...
![Источник](./images/Pasted-image-20250918123420.png)
...
![Приемник](./images/Pasted-image-20250918122324.png)
...
# 7. <a name='past'></a>Прошлое

// TODO
Как был разработан продукт. Можно указать где работает, если нам это разрешено.

# 8. <a name='how_to_get_help'></a>Как и где получить помощь

[Telegram](https://t.me/rdv_mi)

##  9. <a name='joint_development'></a>Совместное развитие
...
###  9.1. <a name='how_to_help'></a>Как вы можете помочь
...
###  9.2. <a name='contribution'></a>Как происходит процесс contribution
...
###  9.3. <a name='obligations_to_the_community'></a>Наши обязательства перед сообществом:
