...
1. Типовая (базовая) логика, все не Демо модули. Не рекомендуется вносить изменения, например, [модуль интеграции](./3%201%20transport.md).
2. Модифицируемая:
	1. [Демо-реализации](./2%20demo.md) - примеры для решения типовых прикладных задач. Модули с суффиксом Демо.
