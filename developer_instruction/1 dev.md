...
| `рдв_ФормированиеХешейОбъектовПереопределяемый` | Модуль реализует возможность задать правила сверки объектов или определить собственный алгоритм.                                                                                                                                   |
...
2. Модифицируемая:
	1. [Демо-реализации](./2%20demo.md) - примеры для решения типовых задач. Модули с суффиксом Демо (рдв_МодульИнтеграцииДемо). // todo навигация
	...
	2. [Добавление механизма транспорта](./3%202%20new%20transport.md)
